    ...
    for each_dir in data_dir_list:
        ...
        for i in range(cut_factor_row):
            for j in range(cut_factor_clo):
                ...
                src_path = r"C:\Users\mj\Documents\WeChat Files\wxid_daf8d34bzqvz22\FileStorage\File\2023-11\google_18s_nogl_长沙市_开福区_翡翠湾_112.985_28.286_112.998_28.296.tif"  # 带地理影像
...
if __name__ == '__main__':
    ##### cut
    data_dir = 'C:\\Users\\mj\\Documents\\WeChat Files\\wxid_daf8d34bzqvz22\\FileStorage\\File\\2023-11'
    out_dir = 'D:\\test_tif\\18level'
    file_type = ['tif']
    out_type = 'tif'
    cut_size = 256
